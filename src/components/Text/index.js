...
const Text = ({ style, children, fontFamily: propFontFamily, ...props }) => {
  ...
  const getFontFamily = (combinedStyle) => {
    ...
    const currentFontFamily = Object.keys(fontFamilies).find(family => 
    ...
    // For Pixelify Sans
      ...
      if (flatStyle.fontWeight === '600') return 'PixelifySans-Medium';
      if (flatStyle.fontWeight === '500') return 'PixelifySans-Medium';
