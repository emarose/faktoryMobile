...
const FoundryScreen = ({ route, navigation }) => {
  ...
  const availableRecipes = useMemo(() => {
    return Object.values(items)
      .filter((item) => item.machine === "foundry")
      .map((item) => ({
        id: item.id,
        name: item.name,
  ...
  const startCrafting = useCallback(
    async (amountToCraft, isMax = false) => {
      ...
      addToCraftingQueue({
        machineId: machine?.id || "manual-foundry",
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <CustomHeader
        title="Foundry"
        rightIcon="cog"
        onRightIconPress={() => console.log("Foundry tools pressed")}
      />
      <View style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          {activeTab === "recipe" ? (
                  ...
                  >
                    <View style={styles.recipeCardHeader}>
                      <View style={styles.recipeIconContainer}>
                        {items[recipeItem.id] &&
                        items[recipeItem.id].iconName ? (
                          <Image
                            source={
                              GameAssets.icons[items[recipeItem.id].iconName]
                            }
            ...
            // PRODUCTION TAB - Same as ConstructorScreen but adapted for Foundry
            <ScrollView
                    ...
                    <View style={styles.machineInfoCard}>
                      <View style={styles.machineHeader}>
                        <View style={styles.machineIcon}>
                          {items[selectedRecipe.id] &&
                          items[selectedRecipe.id].iconName ? (
                            <Image
                              source={
                                GameAssets.icons[
                                  items[selectedRecipe.id].iconName
                        ...
                        <View style={styles.machineInfo}>
                          <Text style={styles.machineTitle}>Foundry</Text>
...
export default React.memo(FoundryScreen);
