...
const OilExtractorScreen = ({ route, navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <CustomHeader
        ...
        rightIcon="oil"
        borderColor="#ff9800"
        onRightIconPress={() => console.log("Oil extractor tools pressed")}
      />
                ...
                <View style={styles.machineInfoCard}>
                  ...
                  <View style={styles.machineDetails}>
                    <Text style={styles.machineTitle}>
                      {items[machine.type]?.name || "Oil Extractor"}
                    </Text>
...
export default React.memo(OilExtractorScreen);
