...
const AssemblerScreen = ({ route, navigation }) => {
  ...
  const availableRecipes = useMemo(() => {
    return Object.values(items)
      .filter((item) => item.machine === "assembler")
      .map((item) => ({
        id: item.id,
        name: item.name,
  ...
  const startCrafting = useCallback(async (amountToCraft, isMax = false) => {
    ...
    addToCraftingQueue({
      machineId: machine?.id || 'manual-assembler',
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top", "left", "right"]}>
      <CustomHeader 
        title="Assembler"
        rightIcon="cog"
        onRightIconPress={() => console.log("Assembler tools pressed")}
      />
      <View style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          {activeTab === "recipe" ? (
            ...
            // PRODUCTION TAB - Similar to FoundryScreen but adapted for Assembler
            <ScrollView 
                    ...
                    <View style={styles.machineInfoCard}>
                      <View style={styles.machineHeader}>
                        ...
                        <View style={styles.machineInfo}>
                          <Text style={styles.machineTitle}>Assembler</Text>
                ...
                {selectedRecipe && (
                  <View style={styles.controlsSection}>
                    ...
                    >
                      ...
                      >
                        {isProcessing ? "Processing..." : `Start Assembly (${amount}x)`}
                      </Text>
                    </TouchableOpacity>
                  </View>
                )}
...
export default React.memo(AssemblerScreen);