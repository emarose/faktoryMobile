...
const ManufacturerScreen = ({ route, navigation }) => {
  ...
  // Get manufacturer recipes
  const availableRecipes = useMemo(() => {
    return Object.values(items)
      .filter((item) => item.machine === "manufacturer")
      .map((item) => ({
        id: item.id,
        name: item.name,
  ...
  const startCrafting = useCallback(async (amountToCraft, isMax = false) => {
    ...
    addToCraftingQueue({
      machineId: machine?.id || 'manual-manufacturer',
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <CustomHeader 
        title="Manufacturer"
        rightIcon="factory"
        onRightIconPress={() => console.log("Manufacturer tools pressed")}
      />
                    ...
                    <View style={styles.machineInfoCard}>
                      <View style={styles.machineHeader}>
                        ...
                        <View style={styles.machineInfo}>
                          <Text style={styles.machineTitle}>Manufacturer</Text>
                ...
                {selectedRecipe && (
                  <View style={styles.controlsSection}>
                    ...
                    >
                      ...
                      >
                        {isProcessing ? "Processing..." : `Start Manufacturing (${amount}x)`}
                      </Text>
                    </TouchableOpacity>
                  </View>
                )}
...
export default React.memo(ManufacturerScreen);