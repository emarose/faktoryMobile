...
const modalStyles = StyleSheet.create({
  centeredView: {
    ...
    alignItems: "center",
    backgroundColor: Colors.overlay, // Darker overlay, consistent with general theme
  },
  modalView: {
    margin: 20,
    backgroundColor: Colors.background, // Matching buildCard background
    ...
    width: "90%",
    maxHeight: "80%",
    borderColor: Colors.borderLight, // Matching buildCard borderColor
  ...
  modalTitle: {
    ...
    color: Colors.textPrimary, // Matching title color
  ...
  noRecipesText: {
    color: Colors.textMuted, // Matching noItemsText color
  ...
  closeButton: {
    backgroundColor: Colors.accentGreen, // Matching buildButton backgroundColor
  ...
  textStyle: {
    color: Colors.textPrimary, // Matching buildButtonText color
