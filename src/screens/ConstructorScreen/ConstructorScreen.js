...
const ConstructorScreen = ({ route, navigation }) => {
  ...
  const startCrafting = useCallback(async (amountToCraft, isMax = false) => {
    ...
    addToCraftingQueue({
      machineId: machine?.id || 'manual-constructor',
      ...
      <View style={styles.container}>
        ...
        <View style={styles.contentContainer}>
          {activeTab === "recipe" ? (
            ...
            // PRODUCTION TAB - Same as before but simplified
            <ScrollView 
                    ...
                    <View style={styles.machineInfoCard}>
                      <View style={styles.machineHeader}>
                        ...
                        <View style={styles.machineInfo}>
                          <Text style={styles.machineTitle}>Constructor</Text>
...
export default React.memo(ConstructorScreen);